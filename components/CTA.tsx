      ...
      <div className="bg-navy-custom rounded-[32px] md:rounded-[48px] p-8 md:p-20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6">
            <button className="w-full sm:w-auto bg-primary text-navy-custom px-8 md:px-12 py-4 md:py-5 rounded-2xl font-bold text-base md:text-lg hover:scale-105 transition-all">
              Get Started Now
            </button>
